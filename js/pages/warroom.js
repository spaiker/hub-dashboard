...
$('.js-toggle-slide').click(function(){
    ...
    $('.content-body__workspace_warroom').toggleClass('content-body__workspace_no-sidebar');
...
$('.extra-widget-item').click(function(){
    ...
    $('.content-body__workspace_warroom').removeClass('content-body__workspace_no-sidebar');
