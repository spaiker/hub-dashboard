...
(function (global, factory) {
  ...
  var defaultParams = {
    ...
    confirmButtonClass: 'btn btn_blue',
  ...
  var sweetHTML = '<div class="' + swalClasses.modal + '" style="display: none" tabIndex="-1">' +
      ...
      '<div class="' + swalClasses.icon + ' ' + iconTypes.error + '">' +
        '<span class="hb hb-unverified"></span>' +
      '</div>' +
      '<div class="' + swalClasses.icon + ' ' + iconTypes.question + '"><span class="hb hb-question"></span></div>' +
      '<div class="' + swalClasses.icon + ' ' + iconTypes.warning + '"><span class="hb hb-warning"></span></div>' +
      '<div class="' + swalClasses.icon + ' ' + iconTypes.info + '"><span class="hb hb-info"></span></div>' +
      '<div class="' + swalClasses.icon + ' ' + iconTypes.success + '">' +
        '<span class="hb hb-verified"></span>' +
      '</div>' +
